  ...
  return (
    <SafeAreaView>
      ...
      <View style={{flexDirection: 'row',justifyContent: 'space-between',borderColor:COLORS.hey , borderWidth:2,borderRadius:9, width:"94%", height:120,marginTop:80, marginLeft:15}}>
        <View>
            <Text style={{fontSize:18, color:COLORS.hey, marginLeft:7,marginTop:10,padding:15 }}>welcome!! </Text>
        ...
        <View>
            <ImageBackground 
                    source={require('../../assets/images/wwork.png')}
        ...
        <View style={[styles.estatisticas, styles.thisLayout]}>
            <Text style={[styles.thisWeek, styles.thisLayout]}>Ongoing Projects </Text>
        </View>
